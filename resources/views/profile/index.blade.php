...
@section('content')
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7915.126552680351!2d112.811941!3d-7.290426!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1942568d1d6d1707!2sSukolilo+Dian+Regency!5e0!3m2!1sen!2sus!4v1541425562944" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
    <div class="ui three column doubling grid container">
        ...
        <div class="column">
            <div class="ui segment">
                <div class="content">
                    <h2 class="ui header">Showcase</h2>
                </div>
                ...
                <div class="ui cards">
                    <div class="card">
                        <div class="content">
                            ...
                            <div class="meta"><i class="star icon"></i><i class="star icon"></i><i class="star icon"></i><i class="star icon"></i><i class="star icon"></i></div>
                    ...
                    <div class="card">
                        <div class="content">
                            ...
                            <div class="meta"><i class="star icon"></i><i class="star icon"></i><i class="star icon"></i><i class="star icon"></i></div>
                            <div class="description">
                                Andy Printing penjaganya cakep, jadi suka deh ke situ! Kalo ga bisa ke Andy Printing, bisa pesan online juga hehehehe.
                            </div>
                        </div>
                    </div>
                    <div class="card">
